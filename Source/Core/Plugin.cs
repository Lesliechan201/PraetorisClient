...
namespace PraetorisClient
{
    ...
    public class PraetorisClientPlugin : BaseUnityPlugin
    {
        ...
        private void BindConfig()
        {
            ...
            BlockPeerServerSyncConfigSync = Config.Bind("ServerSyncProtection", "BlockPeerServerSyncConfigSync", true, SyncedDescription("Blocks peer-origin ServerSync config packets so Praetoris clients do not publish or accept client-to-client config changes."));
