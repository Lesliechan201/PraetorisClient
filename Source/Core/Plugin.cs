...
namespace PraetorisClient
{
    ...
    public class PraetorisClientPlugin : BaseUnityPlugin
    {
        ...
        private const string ModVersion = "0.1.53";
        ...
        internal static ConfigEntry<bool> BlockAzuAutoStoreClientConfigSync = null!;
        ...
        private void BindConfig()
        {
            ...
            BlockAzuAutoStoreClientConfigSync = Config.Bind("ServerSyncProtection", "BlockAzuAutoStoreClientConfigSync", true, SyncedDescription("Blocks client-origin AzuAutoStore ServerSync config packets so Praetoris clients do not publish or accept peer config changes."));
